...
<form class="form-inline my-2 my-lg-0" action="<?= $this->Url->build(['action' => 'index']) ?>" method="get">
                    ...
                    <td class="actions">
                        ...
                        <?=$this->Html->image("modifier-btn.png", [
                           ...
                           <?= $this->Form->postLink(
                            $this->Html->image(
                                "x.png",
                                ["alt" => "Desactiver", 'class' => 'action-link','title' => 'Desactiver','height' => '15', 'width' => '27']
                            ),
                            ['controller' => 'Attestations', 'action' => 'delete', $attestation->id],
                            ['escape' => false, 'confirm' => __('Voulez-vous desactiver cette attestation?' . $attestation->numero, $attestation->id)]
                        );
                        ?>
                    </td>
                </tr>
