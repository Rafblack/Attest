        ...
        <tr>
            <td style="width: 50%;">
                <div class="form-group">
                    ...
                    echo $this->Form->control('type', ['empty' => true, 'required' => true, 'options' => $types, 'class' => 'form-control']);
   ...
   function resp(typeField){
            ...
            <?php
                echo $this->Form->control('responsable', [
                    ...
                    'id' => 'responsable-nom',
                    'class' => 'form-control',
                    "value"=>$attestation->responsable,
                    'required' => true
                ]);
            ?>

            <?php
                echo $this->Form->control('filiere', [
                    'label' => 'Description du responsable',
                    'id' => 'responsable-filiere',
                    'class' => 'form-control',
                    "value"=>$attestation->filiere,
            ...
            ?>
                     ...
                     $roles =[
                        ...
                        "societe" => "societe",
                           ...
                           echo $this->Form->control('role', ['label'=>'Client_type','empty' => true,"options"=>$roles,'value'=> $attestation->role, 'required' => true, 'class' => 'form-control']);
